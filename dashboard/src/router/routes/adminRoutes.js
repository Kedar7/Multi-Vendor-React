...
const ChatSellerDashboard = lazy (()=> import('../../views/admin/ChatSeller'));
const OrderDetailsDashboard =  lazy(() => import('../../views/admin/OrderDetails'));
