        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Kedar Kulkarni </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Easy Shop</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>Pending</span> </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>kedar@gmail.com </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Bangalore </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>India </td>
